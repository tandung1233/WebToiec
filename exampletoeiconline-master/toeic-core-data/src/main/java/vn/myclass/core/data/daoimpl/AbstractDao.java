...
public class AbstractDao<ID extends Serializable, T> implements GenericDao<ID, T> {
    ...
    //Class này là chung cho 1 đối tượng nào đó
    private Class<T> persistenceClass;//Cái này là đối tượng của 1 class bình thường thôi

    public AbstractDao() {
    	//ID extends Serializable, T id là vị trí 0 T là vị trí 2, 2 cái này là mảng nên chúng ta truyền T thì vị trí là 1
        this.persistenceClass = (Class<T>) ((ParameterizedType)getClass().getGenericSuperclass()).getActualTypeArguments()[1];
    }
    //Chuyển cái class ra tên của class để thực hiện truy vấn ví dụ select * from user,....
